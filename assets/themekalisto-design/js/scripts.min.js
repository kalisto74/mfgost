...
document.addEventListener("touchstart",function(){},!1),$(function(){$(".wsdownmenu").append($('<a class="wsdownmenu-animated-arrow"><span></span></a>')),$(".wsdownmenu-list > li").has(".wsdownmenu-submenu").prepend('<span class="wsdownmenu-click"><i class="wsdownmenu-arrow fa fa-angle-down"></i></span>'),$(".wsdownmenu-submenu > li").has("ul").prepend('<span class="wsdownmenu-click02"><i class="wsdownmenu-arrow fa fa-angle-down"></i></span>'),$(".wsdownmenu-submenu-sub > li").has("ul").prepend('<span class="wsdownmenu-click02"><i class="wsdownmenu-arrow fa fa-angle-down"></i></span>'),$(".wsdownmenu-submenu-sub-sub > li").has("ul").prepend('<span class="wsdownmenu-click02"><i class="wsdownmenu-arrow fa fa-angle-down"></i></span>'),$(".wsdownmenu-list li").has(".megamenu").prepend('<span class="wsdownmenu-click"><i class="wsdownmenu-arrow fa fa-angle-down"></i></span>'),$(".wsdownmenu-animated-arrow").click(function(){$(".wsdownmenu-list").slideToggle("slow"),$(this).toggleClass("wsdownmenu-lines")}),$(".wsdownmenu-click").click(function(){$(this).toggleClass("wsdownmenuarrow-rotate").parent().siblings().children().removeClass("wsdownmenuarrow-rotate"),$(".wsdownmenu-submenu, .megamenu").not($(this).siblings(".wsdownmenu-submenu, .megamenu")).slideUp("slow"),$(this).siblings(".wsdownmenu-submenu").slideToggle("slow"),$(this).siblings(".megamenu").slideToggle("slow")}),$(".wsdownmenu-click02").click(function(){$(this).toggleClass("wsdownmenuarrow-rotate").parent().siblings().children().removeClass("wsdownmenuarrow-rotate"),$(this).siblings(".wsdownmenu-submenu").slideToggle("slow"),$(this).siblings(".wsdownmenu-submenu-sub").slideToggle("slow"),$(this).siblings(".wsdownmenu-submenu-sub-sub").slideToggle("slow")}),window.onresize=function(s){console.log("window resize"),767<$(window).width()&&($(".wsdownmenu-submenu").removeAttr("style"),$(".wsdownmenu-list").removeAttr("style"))}});
...
!function(d){d.fn.pgwSlideshow=function(i){var n={mainClassName:"pgwSlideshow",transitionEffect:"sliding",displayList:!0,displayControls:!0,touchControls:!0,autoSlide:!1,beforeSlide:!1,afterSlide:!1,maxHeight:null,adaptiveDuration:200,transitionDuration:500,intervalDuration:3e3};if(0==this.length)return this;if(1<this.length)return this.each(function(){d(this).pgwSlideshow(i)}),this;var u=this;u.plugin=this,u.config={},u.data=[],u.currentSlide=0,u.slideCount=0,u.resizeEvent=null,u.intervalEvent=null,u.touchFirstPosition=null,u.touchListLastPosition=!1,u.window=d(window);var e=function(i,n){return u.config.maxHeight&&i+u.plugin.find(".ps-list").height()>u.config.maxHeight&&(i=u.config.maxHeight-u.plugin.find(".ps-list").height()),"function"==typeof u.plugin.find(".ps-current").animate?u.plugin.find(".ps-current").stop().animate({height:i},u.config.adaptiveDuration,function(){u.config.maxHeight&&u.plugin.find(".ps-current > ul > li img").css("max-height",i+"px")}):(u.plugin.find(".ps-current").css("height",i),u.config.maxHeight&&u.plugin.find(".ps-current > ul > li img").css("max-height",i+"px")),!0},l=function(){var i=0;return u.plugin.show(),u.plugin.find(".ps-list > ul > li").show().each(function(){i+=d(this).width()}),u.plugin.find(".ps-list > ul").width(i),!0},s=function(){return u.plugin.width()<=480?u.plugin.addClass("narrow").removeClass("wide"):u.plugin.addClass("wide").removeClass("narrow"),!0},t=function(){if(u.plugin.removeClass("pgwSlideshow").removeClass(u.config.mainClassName),u.plugin.wrap('<div class="ps-list"></div>'),u.plugin=u.plugin.parent(),u.plugin.wrap('<div class="'+u.config.mainClassName+'"></div>'),u.plugin=u.plugin.parent(),u.plugin.prepend('<div class="ps-current"><ul></ul><span class="ps-caption"></span></div>'),u.slideCount=u.plugin.find(".ps-list > ul > li").length,0==u.slideCount)throw new Error("pgwSlideshow - No slider item has been found");1<u.slideCount&&(u.config.displayControls&&(u.plugin.find(".ps-current").prepend('<span class="ps-prev"><span class="ps-prevIcon"></span></span>'),u.plugin.find(".ps-current").append('<span class="ps-next"><span class="ps-nextIcon"></span></span>'),u.plugin.find(".ps-current .ps-prev").click(function(){u.previousSlide()}),u.plugin.find(".ps-current .ps-next").click(function(){u.nextSlide()})),u.config.touchControls&&(u.plugin.find(".ps-current").on("touchstart",function(i){try{i.originalEvent.touches[0].clientX&&null==u.touchFirstPosition&&(u.touchFirstPosition=i.originalEvent.touches[0].clientX)}catch(i){u.touchFirstPosition=null}}),u.plugin.find(".ps-current").on("touchmove",function(i){try{i.originalEvent.touches[0].clientX&&null!=u.touchFirstPosition&&(i.originalEvent.touches[0].clientX>u.touchFirstPosition+50?(u.touchFirstPosition=null,u.previousSlide()):i.originalEvent.touches[0].clientX<u.touchFirstPosition-50&&(u.touchFirstPosition=null,u.nextSlide()))}catch(i){u.touchFirstPosition=null}}),u.plugin.find(".ps-current").on("touchend",function(i){u.touchFirstPosition=null})));var t=1;return u.plugin.find(".ps-list > ul > li").each(function(){var n=o(d(this));n.id=t,u.data.push(n),d(this).addClass("elt_"+n.id),d(this).wrapInner('<span class="ps-item'+(1==t?" ps-selected":"")+'"></span>');var i=d('<li class="elt_'+t+'"></li>');n.image?i.html('<img src="'+n.image+'" alt="'+(n.title?n.title:"")+'">'):n.thumbnail&&i.html('<img src="'+n.thumbnail+'" alt="'+(n.title?n.title:"")+'">'),n.link&&i.html('<a href="'+n.link+'"'+(n.linkTarget?' target="'+n.linkTarget+'"':"")+">"+i.html()+"</a>"),u.plugin.find(".ps-current > ul").append(i),d(this).css("cursor","pointer").click(function(i){i.preventDefault(),r(n.id)}),t++}),u.config.displayList?(l(),u.plugin.find(".ps-list").prepend('<span class="ps-prev"><span class="ps-prevIcon"></span></span>'),u.plugin.find(".ps-list").append('<span class="ps-next"><span class="ps-nextIcon"></span></span>'),u.plugin.find(".ps-list").show()):u.plugin.find(".ps-list").hide(),u.config.autoSlide&&u.plugin.on("mouseenter",function(){clearInterval(u.intervalEvent),u.intervalEvent=null}).on("mouseleave",function(){c()}),u.plugin.find(".ps-current > ul > li").hide(),r(1),u.plugin.find(".ps-current > ul > li.elt_1 img").on("load",function(){s();var i=u.plugin.find(".ps-current > ul > li.elt_1 img").height();e(i)}),s(),u.plugin.show(),!0},o=function(i){var n={},t=i.find("a").attr("href");if(void 0!==t&&""!=t){n.link=t;var e=i.find("a").attr("target");void 0!==e&&""!=e&&(n.linkTarget=e)}var s=i.find("img").attr("src");void 0!==s&&""!=s&&(n.thumbnail=s);var l=i.find("img").attr("data-large-src");void 0!==l&&""!=l&&(n.image=l);var o=i.find("img").attr("alt");void 0!==o&&""!=o&&(n.title=o);var r=i.find("img").attr("data-description");return void 0!==r&&""!=r&&(n.description=r),n},a=function(i){var n="";i.title&&(n+="<b>"+i.title+"</b>"),i.description&&(""!=n&&(n+="<br>"),n+=i.description),""!=n&&(i.link&&(n='<a href="'+i.link+'"'+(i.linkTarget?' target="'+i.linkTarget+'"':"")+">"+n+"</a>"),"function"==typeof u.plugin.find(".ps-caption").fadeIn?(u.plugin.find(".ps-caption").html(n),u.plugin.find(".ps-caption").fadeIn(u.config.transitionDuration/2)):(u.plugin.find(".ps-caption").html(n),u.plugin.find(".ps-caption").show())),u.plugin.find(".ps-list > ul > li .ps-item").removeClass("ps-selected"),u.plugin.find(".ps-list > ul > li.elt_"+i.id+" .ps-item").addClass("ps-selected"),u.config.displayList&&(p(),f()),u.config.displayControls&&("function"==typeof u.plugin.find(".ps-current > .ps-prev").fadeIn?u.plugin.find(".ps-current > .ps-prev, .ps-current > .ps-next").fadeIn(u.config.transitionDuration/2):u.plugin.find(".ps-current > .ps-prev, .ps-current > .ps-next").show()),"function"==typeof u.config.afterSlide&&u.config.afterSlide(i.id);var t=u.plugin.find(".ps-current .elt_"+i.id+" img").height();return e(t,!0),!0},r=function(i,n,t){if(i==u.currentSlide)return!1;var e=u.data[i-1];if(void 0===e)throw new Error("pgwSlideshow - The element "+i+" is undefined");return void 0===t&&(t="left"),"function"==typeof u.config.beforeSlide&&u.config.beforeSlide(i),"function"==typeof u.plugin.find(".ps-caption").fadeOut?u.plugin.find(".ps-caption, .ps-prev, .ps-next").fadeOut(u.config.transitionDuration/2):u.plugin.find(".ps-caption, .ps-prev, .ps-next").hide(),"sliding"==u.config.transitionEffect?function(i,n){var t=u.plugin.find(".ps-current > ul");if(void 0===n&&(n="left"),0==u.currentSlide)t.find(".elt_1").css({position:"",left:"",opacity:1,"z-index":2}).show(),u.plugin.find(".ps-list > li.elt_1").css("opacity","1"),a(i);else{if(u.transitionInProgress)return;u.transitionInProgress=!0;var e=t.width();if("left"==n)var s=-e,l=e;else l=-(s=e);var o=t.find(".elt_"+u.currentSlide);"function"!=typeof o.animate&&(o.animate=function(i,n,t){o.css(i),t&&t()}),o.css("position","absolute").animate({left:s},u.config.transitionDuration,function(){o.css("position","").css("z-index",1).css("left","").css("opacity",0).hide()});var r=t.find(".elt_"+i.id);"function"!=typeof r.animate&&(r.animate=function(i,n,t){r.css(i),t&&t()}),r.css("position","absolute").css("left",l).css("opacity",1).show().animate({left:0},u.config.transitionDuration,function(){r.css("position","").css("left","").css("z-index",2).show(),u.transitionInProgress=!1,a(i)})}u.currentSlide=i.id}(e,t):function(i){var n=u.plugin.find(".ps-current > ul");if(n.find("li").not(".elt_"+u.currentSlide).not(".elt_"+i.id).each(function(){"function"==typeof d(this).stop&&d(this).stop(),d(this).css("position","").css("z-index",1).hide()}),0<u.currentSlide){var e=n.find(".elt_"+u.currentSlide);"function"!=typeof e.animate&&(e.animate=function(i,n,t){e.css(i),t&&t()}),"function"==typeof e.stop&&e.stop(),e.css("position","absolute").animate({opacity:0},u.config.transitionDuration,function(){e.css("position","").css("z-index",1).hide()})}u.currentSlide=i.id;var s=n.find(".elt_"+i.id);"function"!=typeof s.animate&&(s.animate=function(i,n,t){s.css(i),t&&t()}),"function"==typeof s.stop&&s.stop(),s.css("position","absolute").show().animate({opacity:1},u.config.transitionDuration,function(){s.css("position","").css("z-index",2).css("display","block"),a(i)})}(e),void 0!==n&&u.config.autoSlide&&c(),!0},c=function(){return clearInterval(u.intervalEvent),1<u.slideCount&&u.config.autoSlide&&(u.intervalEvent=setInterval(function(){if(u.currentSlide+1<=u.slideCount)var i=u.currentSlide+1;else i=1;r(i)},u.config.intervalDuration)),!0},p=function(){if(!u.config.displayList)return!1;l();var o=u.plugin.find(".ps-list"),e=o.width(),r=u.plugin.find(".ps-list > ul"),s=r.width();if(e<s){r.css("margin","0 45px");var i=parseInt(r.css("margin-left")),n=parseInt(r.css("margin-right"));e-=i+n,o.find(".ps-prev").show().unbind("click").click(function(){var i=parseInt(r.css("left")),n=i+e;0==i?n=-(s-e):0<n&&(n=0),"function"==typeof r.animate?r.animate({left:n},u.config.transitionDuration):r.css("left",n)}),o.find(".ps-next").show().unbind("click").click(function(){var i=parseInt(r.css("left")),n=i-e,t=-(s-e);i==t?n=0:n<t&&(n=t),"function"==typeof r.animate?r.animate({left:n},u.config.transitionDuration):r.css("left",n)}),u.config.touchControls&&(u.plugin.find(".ps-list > ul").on("touchmove",function(i){try{if(i.originalEvent.touches[0].clientX){var n=0==u.touchListLastPosition?0:u.touchListLastPosition;nbPixels=0==u.touchListLastPosition?1:Math.abs(n-i.originalEvent.touches[0].clientX),u.touchListLastPosition=i.originalEvent.touches[0].clientX;var t="";n>i.originalEvent.touches[0].clientX?t="left":n<i.originalEvent.touches[0].clientX&&(t="right")}var e=parseInt(r.css("left"));if("left"==t){var s=o.width();-(r.width()-(s-=parseInt(r.css("margin-left"))+parseInt(r.css("margin-right"))))<(l=e-nbPixels)&&r.css("left",l)}else{var l;if("right"==t)(l=e+nbPixels)<0?r.css("left",l):r.css("left",0)}}catch(i){u.touchListLastPosition=!1}}),u.plugin.find(".ps-list > ul").on("touchend",function(i){u.touchListLastPosition=!1}))}else{i=parseInt((e-s)/2);r.css("left",0).css("margin-left",i),o.find(".ps-prev").hide(),o.find(".ps-next").hide(),u.plugin.find(".ps-list > ul").unbind("touchstart touchmove touchend")}return!0},f=function(){var i=u.plugin.find(".ps-list").width(),n=u.plugin.find(".ps-list > ul"),t=n.width();i-=parseInt(n.css("margin-left"))+parseInt(n.css("margin-right"));var e=Math.abs(parseInt(n.css("left"))),s=e+i,l=u.plugin.find(".ps-list .ps-selected").position().left,o=l+u.plugin.find(".ps-list .ps-selected").width();if(l<e||s<o||i<t&&o<s){var r=-(t-i);-l<r?n.css("left",r):n.css("left",-l)}return!0};return u.startSlide=function(){return u.config.autoSlide=!0,c(),!0},u.stopSlide=function(){return u.config.autoSlide=!1,clearInterval(u.intervalEvent),!0},u.getCurrentSlide=function(){return u.currentSlide},u.getSlideCount=function(){return u.slideCount},u.displaySlide=function(i){return r(i,!0),!0},u.nextSlide=function(){if(u.currentSlide+1<=u.slideCount)var i=u.currentSlide+1;else i=1;return r(i,!0,"left"),!0},u.previousSlide=function(){if(1<=u.currentSlide-1)var i=u.currentSlide-1;else i=u.slideCount;return r(i,!0,"right"),!0},u.destroy=function(i){return clearInterval(u.intervalEvent),void 0!==i?(u.plugin.find(".ps-list > ul > li").each(function(){d(this).attr("style",null).removeClass().unbind("click"),d(this).html(d(this).find("span").html())}),u.plugin.find(".ps-current").remove(),u.plugin.find(".ps-list").find(".ps-prev, .ps-next").remove(),u.plugin.find(".ps-list > ul").addClass(u.config.mainClassName).attr("style",""),u.plugin.find(".ps-list > ul").unwrap().unwrap(),u.hide()):u.parent().parent().remove(),u.plugin=null,u.data=[],u.config={},u.currentSlide=0,u.slideCount=0,u.resizeEvent=null,u.intervalEvent=null,u.touchFirstPosition=null,!(u.window=null)},u.reload=function(i){return u.destroy(!0),(u=this).plugin=this,u.window=d(window),u.plugin.show(),u.config=d.extend({},n,i),t(),u.window.resize(function(){clearTimeout(u.resizeEvent),u.resizeEvent=setTimeout(function(){s();var i=u.plugin.find(".ps-current > ul > li.elt_"+u.currentSlide+" img").css("max-height","").height();e(i),u.config.displayList&&(p(),f())},100)}),u.config.autoSlide&&c(),!0},u.config=d.extend({},n,i),t(),u.config.displayList&&p(),u.window.resize(function(){clearTimeout(u.resizeEvent),u.resizeEvent=setTimeout(function(){s();var i=u.plugin.find(".ps-current > ul > li.elt_"+u.currentSlide+" img").height();e(i),u.config.displayList&&(p(),f())},100)}),u.config.autoSlide&&c(),this}}(window.Zepto||window.jQuery);
!function(b){var v=function(e){return e.split("").reverse().join("")},p={numberStep:function(e,t){var n=Math.floor(e);b(t.elem).text(n)}},e=function(e){var t=e.elem;t.nodeType&&t.parentNode&&((t=t._animateNumberSetter)||(t=p.numberStep),t(e.now,e))};b.Tween&&b.Tween.propHooks?b.Tween.propHooks.number={set:e}:b.fx.step.number=e,b.animateNumber={numberStepFactories:{append:function(r){return function(e,t){var n=Math.floor(e);b(t.elem).prop("number",e).text(n+r)}},separator:function(c,h,s){return c=c||" ",h=h||3,s=s||"",function(e,t){var n=Math.floor(e).toString(),r=b(t.elem);if(n.length>h){for(var o,a,i,u=n,p=h,m=u.split("").reverse(),f=(n=[],0),l=Math.ceil(u.length/p);f<l;f++){for(o="",i=0;i<p&&(a=f*p+i)!==u.length;i++)o+=m[a];n.push(o)}u=n.length-1,p=v(n[u]),n[u]=v(parseInt(p,10).toString()),n=n.join(c),n=v(n)}r.prop("number",e).text(n+s)}}}},b.fn.animateNumber=function(){for(var e=arguments[0],t=b.extend({},p,e),n=b(this),r=[t],o=1,a=arguments.length;o<a;o++)r.push(arguments[o]);if(e.numberStep){var i=this.each(function(){this._animateNumberSetter=e.numberStep}),u=t.complete;t.complete=function(){i.each(function(){delete this._animateNumberSetter}),u&&u.apply(this,arguments)}}return n.animate.apply(n,r)}}(jQuery);
!function(t,e){"function"==typeof define&&define.amd?define("sifter",e):"object"==typeof exports?module.exports=e():t.Sifter=e()}(this,function(){var t=function(t,e){this.items=t,this.settings=e||{diacritics:!0}};t.prototype.tokenize=function(t){if(!(t=a(String(t||"").toLowerCase()))||!t.length)return[];var e,n,i,o,r=[],s=t.split(/ +/);for(e=0,n=s.length;e<n;e++){if(i=l(s[e]),this.settings.diacritics)for(o in p)p.hasOwnProperty(o)&&(i=i.replace(new RegExp(o,"g"),p[o]));r.push({string:s[e],regex:new RegExp(i,"i")})}return r},t.prototype.iterator=function(t,e){(s(t)?Array.prototype.forEach||function(t){for(var e=0,n=this.length;e<n;e++)t(this[e],e,this)}:function(t){for(var e in this)this.hasOwnProperty(e)&&t(this[e],e,this)}).apply(t,[e])},t.prototype.getScoreFunction=function(t,e){var o,r,s;t=this.prepareSearch(t,e),r=t.tokens,o=t.options.fields,s=r.length;var a,l=function(t,e){var n,i;return t?-1===(i=(t=String(t||"")).search(e.regex))?0:(n=e.string.length/t.length,0===i&&(n+=.5),n):0},p=(a=o.length)?1===a?function(t,e){return l(e[o[0]],t)}:function(t,e){for(var n=0,i=0;n<a;n++)i+=l(e[o[n]],t);return i/a}:function(){return 0};return s?1===s?function(t){return p(r[0],t)}:"and"===t.options.conjunction?function(t){for(var e,n=0,i=0;n<s;n++){if((e=p(r[n],t))<=0)return 0;i+=e}return i/s}:function(t){for(var e=0,n=0;e<s;e++)n+=p(r[e],t);return n/s}:function(){return 0}},t.prototype.getSortFunction=function(t,e){var n,i,o,r,s,a,l,p,u,c,d;if(d=!(t=(o=this).prepareSearch(t,e)).query&&e.sort_empty||e.sort,u=function(t,e){return"$score"===t?e.score:o.items[e.id][t]},s=[],d)for(n=0,i=d.length;n<i;n++)(t.query||"$score"!==d[n].field)&&s.push(d[n]);if(t.query){for(c=!0,n=0,i=s.length;n<i;n++)if("$score"===s[n].field){c=!1;break}c&&s.unshift({field:"$score",direction:"desc"})}else for(n=0,i=s.length;n<i;n++)if("$score"===s[n].field){s.splice(n,1);break}for(p=[],n=0,i=s.length;n<i;n++)p.push("desc"===s[n].direction?-1:1);return(a=s.length)?1===a?(r=s[0].field,l=p[0],function(t,e){return l*h(u(r,t),u(r,e))}):function(t,e){var n,i,o;for(n=0;n<a;n++)if(o=s[n].field,i=p[n]*h(u(o,t),u(o,e)))return i;return 0}:null},t.prototype.prepareSearch=function(t,e){if("object"==typeof t)return t;var n=(e=r({},e)).fields,i=e.sort,o=e.sort_empty;return n&&!s(n)&&(e.fields=[n]),i&&!s(i)&&(e.sort=[i]),o&&!s(o)&&(e.sort_empty=[o]),{options:e,query:String(t||"").toLowerCase(),tokens:this.tokenize(t),total:0,items:[]}},t.prototype.search=function(t,n){var i,o,e,r,s=this;return o=this.prepareSearch(t,n),n=o.options,t=o.query,r=n.score||s.getScoreFunction(o),t.length?s.iterator(s.items,function(t,e){i=r(t),(!1===n.filter||0<i)&&o.items.push({score:i,id:e})}):s.iterator(s.items,function(t,e){o.items.push({score:1,id:e})}),(e=s.getSortFunction(o,n))&&o.items.sort(e),o.total=o.items.length,"number"==typeof n.limit&&(o.items=o.items.slice(0,n.limit)),o};var h=function(t,e){return"number"==typeof t&&"number"==typeof e||(t=n(String(t||"")),e=n(String(e||""))),e<t?1:t<e?-1:0},r=function(t){var e,n,i,o;for(e=1,n=arguments.length;e<n;e++)if(o=arguments[e])for(i in o)o.hasOwnProperty(i)&&(t[i]=o[i]);return t},a=function(t){return(t+"").replace(/^\s+|\s+$|/g,"")},l=function(t){return(t+"").replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")},s=Array.isArray||$&&$.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)},p={a:"[aÀÁÂÃÄÅàáâãäåĀāąĄ]",c:"[cÇçćĆčČ]",d:"[dđĐďĎ]",e:"[eÈÉÊËèéêëěĚĒēęĘ]",i:"[iÌÍÎÏìíîïĪī]",l:"[lłŁ]",n:"[nÑñňŇńŃ]",o:"[oÒÓÔÕÕÖØòóôõöøŌō]",r:"[rřŘ]",s:"[sŠšśŚ]",t:"[tťŤ]",u:"[uÙÚÛÜùúûüůŮŪū]",y:"[yŸÿýÝ]",z:"[zŽžżŻźŹ]"},n=function(){var t,e,n,i,o="",r={};for(n in p)if(p.hasOwnProperty(n))for(o+=i=p[n].substring(2,p[n].length-1),t=0,e=i.length;t<e;t++)r[i.charAt(t)]=n;var s=new RegExp("["+o+"]","g");return function(t){return t.replace(s,function(t){return r[t]}).toLowerCase()}}();return t}),function(t,e){"function"==typeof define&&define.amd?define("microplugin",e):"object"==typeof exports?module.exports=e():t.MicroPlugin=e()}(this,function(){var t={mixin:function(i){i.plugins={},i.prototype.initializePlugins=function(t){var e,n,i,o=[];if(this.plugins={names:[],settings:{},requested:{},loaded:{}},r.isArray(t))for(e=0,n=t.length;e<n;e++)"string"==typeof t[e]?o.push(t[e]):(this.plugins.settings[t[e].name]=t[e].options,o.push(t[e].name));else if(t)for(i in t)t.hasOwnProperty(i)&&(this.plugins.settings[i]=t[i],o.push(i));for(;o.length;)this.require(o.shift())},i.prototype.loadPlugin=function(t){var e=this.plugins,n=i.plugins[t];if(!i.plugins.hasOwnProperty(t))throw new Error('Unable to find "'+t+'" plugin');e.requested[t]=!0,e.loaded[t]=n.fn.apply(this,[this.plugins.settings[t]||{}]),e.names.push(t)},i.prototype.require=function(t){var e=this.plugins;if(!this.plugins.loaded.hasOwnProperty(t)){if(e.requested[t])throw new Error('Plugin has circular dependency ("'+t+'")');this.loadPlugin(t)}return e.loaded[t]},i.define=function(t,e){i.plugins[t]={name:t,fn:e}}}},r={isArray:Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}};return t}),function(t,e){"function"==typeof define&&define.amd?define("selectize",["jquery","sifter","microplugin"],e):"object"==typeof exports?module.exports=e(require("jquery"),require("sifter"),require("microplugin")):t.Selectize=e(t.jQuery,t.Sifter,t.MicroPlugin)}(this,function(C,c,t){"use strict";var b=function(t,e){if("string"!=typeof e||e.length){var l="string"==typeof e?new RegExp(e,"i"):e,p=function(t){var e=0;if(3===t.nodeType){var n=t.data.search(l);if(0<=n&&0<t.data.length){var i=t.data.match(l),o=document.createElement("span");o.className="highlight";var r=t.splitText(n),s=(r.splitText(i[0].length),r.cloneNode(!0));o.appendChild(s),r.parentNode.replaceChild(o,r),e=1}}else if(1===t.nodeType&&t.childNodes&&!/(script|style)/i.test(t.tagName))for(var a=0;a<t.childNodes.length;++a)a+=p(t.childNodes[a]);return e};return t.each(function(){p(this)})}},i=function(){};i.prototype={on:function(t,e){this._events=this._events||{},this._events[t]=this._events[t]||[],this._events[t].push(e)},off:function(t,e){var n=arguments.length;return 0===n?delete this._events:1===n?delete this._events[t]:(this._events=this._events||{},void(t in this._events!=0&&this._events[t].splice(this._events[t].indexOf(e),1)))},trigger:function(t){if(this._events=this._events||{},t in this._events!=0)for(var e=0;e<this._events[t].length;e++)this._events[t][e].apply(this,Array.prototype.slice.call(arguments,1))}},i.mixin=function(t){for(var e=["on","off","trigger"],n=0;n<e.length;n++)t.prototype[e[n]]=i.prototype[e[n]]};var O=/Mac/.test(navigator.userAgent),$=O?91:17,x=O?18:17,S=!/android/i.test(window.navigator.userAgent)&&!!document.createElement("form").validity,p=function(t){return void 0!==t},I=function(t){return null==t?null:"boolean"==typeof t?t?"1":"0":t+""},l=function(t){return(t+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")},u=function(t){return(t+"").replace(/\$/g,"$$$$")},e={before:function(t,e,n){var i=t[e];t[e]=function(){return n.apply(t,arguments),i.apply(t,arguments)}},after:function(e,t,n){var i=e[t];e[t]=function(){var t=i.apply(e,arguments);return n.apply(e,arguments),t}}},n=function(e,n,t){var i,o=e.trigger,r={};for(i in e.trigger=function(){var t=arguments[0];return-1===n.indexOf(t)?o.apply(e,arguments):void(r[t]=arguments)},t.apply(e,[]),e.trigger=o,r)r.hasOwnProperty(i)&&o.apply(e,r[i])},d=function(t){var e={};if("selectionStart"in t)e.start=t.selectionStart,e.length=t.selectionEnd-e.start;else if(document.selection){t.focus();var n=document.selection.createRange(),i=document.selection.createRange().text.length;n.moveStart("character",-t.value.length),e.start=n.text.length-i,e.length=i}return e},_=function(u){var c=null,t=function(t,e){var n,i,o,r,s,a,l,p;e=e||{},(t=t||window.event||{}).metaKey||t.altKey||(e.force||!1!==u.data("grow"))&&(n=u.val(),t.type&&"keydown"===t.type.toLowerCase()&&(o=97<=(i=t.keyCode)&&i<=122||65<=i&&i<=90||48<=i&&i<=57||32===i,46===i||8===i?(p=d(u[0])).length?n=n.substring(0,p.start)+n.substring(p.start+p.length):8===i&&p.start?n=n.substring(0,p.start-1)+n.substring(p.start+1):46===i&&void 0!==p.start&&(n=n.substring(0,p.start)+n.substring(p.start+1)):o&&(a=t.shiftKey,l=String.fromCharCode(t.keyCode),n+=l=a?l.toUpperCase():l.toLowerCase())),r=u.attr("placeholder"),!n&&r&&(n=r),(s=function(t,e){if(!t)return 0;var n=C("<test>").css({position:"absolute",top:-99999,left:-99999,width:"auto",padding:0,whiteSpace:"pre"}).text(t).appendTo("body");!function(t,e,n){var i,o,r={};if(n)for(i=0,o=n.length;i<o;i++)r[n[i]]=t.css(n[i]);else r=t.css();e.css(r)}(e,n,["letterSpacing","fontSize","fontFamily","fontWeight","textTransform"]);var i=n.width();return n.remove(),i}(n,u)+4)!==c&&(c=s,u.width(s),u.triggerHandler("resize")))};u.on("keydown keyup update blur",t),t()},y=function(t,e){var n,i,o,r,s=this;(r=t[0]).selectize=s;var a,l,p,u=window.getComputedStyle&&window.getComputedStyle(r,null);if(o=(o=u?u.getPropertyValue("direction"):r.currentStyle&&r.currentStyle.direction)||t.parents("[dir]:first").attr("dir")||"",C.extend(s,{order:0,settings:e,$input:t,tabIndex:t.attr("tabindex")||"",tagType:"select"===r.tagName.toLowerCase()?1:2,rtl:/rtl/i.test(o),eventNS:".selectize"+ ++y.count,highlightedValue:null,isOpen:!1,isDisabled:!1,isRequired:t.is("[required]"),isInvalid:!1,isLocked:!1,isFocused:!1,isInputHidden:!1,isSetup:!1,isShiftDown:!1,isCmdDown:!1,isCtrlDown:!1,ignoreFocus:!1,ignoreBlur:!1,ignoreHover:!1,hasOptions:!1,currentResults:null,lastValue:"",caretPos:0,loading:0,loadedSearches:{},$activeOption:null,$activeItems:[],optgroups:{},options:{},userOptions:{},items:[],renderCache:{},onSearchChange:null===e.loadThrottle?s.onSearchChange:(a=s.onSearchChange,l=e.loadThrottle,function(){var t=this,e=arguments;window.clearTimeout(p),p=window.setTimeout(function(){a.apply(t,e)},l)})}),s.sifter=new c(this.options,{diacritics:e.diacritics}),s.settings.options){for(n=0,i=s.settings.options.length;n<i;n++)s.registerOption(s.settings.options[n]);delete s.settings.options}if(s.settings.optgroups){for(n=0,i=s.settings.optgroups.length;n<i;n++)s.registerOptionGroup(s.settings.optgroups[n]);delete s.settings.optgroups}s.settings.mode=s.settings.mode||(1===s.settings.maxItems?"single":"multi"),"boolean"!=typeof s.settings.hideSelected&&(s.settings.hideSelected="multi"===s.settings.mode),s.initializePlugins(s.settings.plugins),s.setupCallbacks(),s.setupTemplates(),s.setup()};return i.mixin(y),t.mixin(y),C.extend(y.prototype,{setup:function(){var t,e,n,i,o,r,s,a,l,p,u,c,d,h=this,g=h.settings,f=h.eventNS,v=C(window),m=C(document),y=h.$input;if(s=h.settings.mode,a=y.attr("class")||"",t=C("<div>").addClass(g.wrapperClass).addClass(a).addClass(s),e=C("<div>").addClass(g.inputClass).addClass("items").appendTo(t),n=C('<input type="text" autocomplete="off" />').appendTo(e).attr("tabindex",y.is(":disabled")?"-1":h.tabIndex),r=C(g.dropdownParent||t),i=C("<div>").addClass(g.dropdownClass).addClass(s).hide().appendTo(r),o=C("<div>").addClass(g.dropdownContentClass).appendTo(i),h.settings.copyClassesToDropdown&&i.addClass(a),t.css({width:y[0].style.width}),h.plugins.names.length&&(l="plugin-"+h.plugins.names.join(" plugin-"),t.addClass(l),i.addClass(l)),(null===g.maxItems||1<g.maxItems)&&1===h.tagType&&y.attr("multiple","multiple"),h.settings.placeholder&&n.attr("placeholder",g.placeholder),!h.settings.splitOn&&h.settings.delimiter){var w=h.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&");h.settings.splitOn=new RegExp("\\s*"+w+"+\\s*")}y.attr("autocorrect")&&n.attr("autocorrect",y.attr("autocorrect")),y.attr("autocapitalize")&&n.attr("autocapitalize",y.attr("autocapitalize")),h.$wrapper=t,h.$control=e,h.$control_input=n,h.$dropdown=i,h.$dropdown_content=o,i.on("mouseenter","[data-selectable]",function(){return h.onOptionHover.apply(h,arguments)}),i.on("mousedown click","[data-selectable]",function(){return h.onOptionSelect.apply(h,arguments)}),u="mousedown",c="*:not(input)",d=function(){return h.onItemSelect.apply(h,arguments)},(p=e).on(u,c,function(t){for(var e=t.target;e&&e.parentNode!==p[0];)e=e.parentNode;return t.currentTarget=e,d.apply(this,[t])}),_(n),e.on({mousedown:function(){return h.onMouseDown.apply(h,arguments)},click:function(){return h.onClick.apply(h,arguments)}}),n.on({mousedown:function(t){t.stopPropagation()},keydown:function(){return h.onKeyDown.apply(h,arguments)},keyup:function(){return h.onKeyUp.apply(h,arguments)},keypress:function(){return h.onKeyPress.apply(h,arguments)},resize:function(){h.positionDropdown.apply(h,[])},blur:function(){return h.onBlur.apply(h,arguments)},focus:function(){return h.ignoreBlur=!1,h.onFocus.apply(h,arguments)},paste:function(){return h.onPaste.apply(h,arguments)}}),m.on("keydown"+f,function(t){h.isCmdDown=t[O?"metaKey":"ctrlKey"],h.isCtrlDown=t[O?"altKey":"ctrlKey"],h.isShiftDown=t.shiftKey}),m.on("keyup"+f,function(t){t.keyCode===x&&(h.isCtrlDown=!1),16===t.keyCode&&(h.isShiftDown=!1),t.keyCode===$&&(h.isCmdDown=!1)}),m.on("mousedown"+f,function(t){if(h.isFocused){if(t.target===h.$dropdown[0]||t.target.parentNode===h.$dropdown[0])return!1;h.$control.has(t.target).length||t.target===h.$control[0]||h.blur(t.target)}}),v.on(["scroll"+f,"resize"+f].join(" "),function(){h.isOpen&&h.positionDropdown.apply(h,arguments)}),v.on("mousemove"+f,function(){h.ignoreHover=!1}),this.revertSettings={$children:y.children().detach(),tabindex:y.attr("tabindex")},y.attr("tabindex",-1).hide().after(h.$wrapper),C.isArray(g.items)&&(h.setValue(g.items),delete g.items),S&&y.on("invalid"+f,function(t){t.preventDefault(),h.isInvalid=!0,h.refreshState()}),h.updateOriginalInput(),h.refreshItems(),h.refreshState(),h.updatePlaceholder(),h.isSetup=!0,y.is(":disabled")&&h.disable(),h.on("change",this.onChange),y.data("selectize",h),y.addClass("selectized"),h.trigger("initialize"),!0===g.preload&&h.onSearchChange("")},setupTemplates:function(){var n=this.settings.labelField,i=this.settings.optgroupLabelField,t={optgroup:function(t){return'<div class="optgroup">'+t.html+"</div>"},optgroup_header:function(t,e){return'<div class="optgroup-header">'+e(t[i])+"</div>"},option:function(t,e){return'<div class="option">'+e(t[n])+"</div>"},item:function(t,e){return'<div class="item">'+e(t[n])+"</div>"},option_create:function(t,e){return'<div class="create">Add <strong>'+e(t.input)+"</strong>&hellip;</div>"}};this.settings.render=C.extend({},t,this.settings.render)},setupCallbacks:function(){var t,e,n={initialize:"onInitialize",change:"onChange",item_add:"onItemAdd",item_remove:"onItemRemove",clear:"onClear",option_add:"onOptionAdd",option_remove:"onOptionRemove",option_clear:"onOptionClear",optgroup_add:"onOptionGroupAdd",optgroup_remove:"onOptionGroupRemove",optgroup_clear:"onOptionGroupClear",dropdown_open:"onDropdownOpen",dropdown_close:"onDropdownClose",type:"onType",load:"onLoad",focus:"onFocus",blur:"onBlur"};for(t in n)n.hasOwnProperty(t)&&((e=this.settings[n[t]])&&this.on(t,e))},onClick:function(t){this.isFocused||(this.focus(),t.preventDefault())},onMouseDown:function(t){var e=this,n=t.isDefaultPrevented();if(C(t.target),e.isFocused){if(t.target!==e.$control_input[0])return"single"===e.settings.mode?e.isOpen?e.close():e.open():n||e.setActiveItem(null),!1}else n||window.setTimeout(function(){e.focus()},0)},onChange:function(){this.$input.trigger("change")},onPaste:function(t){var i=this;i.isFull()||i.isInputHidden||i.isLocked?t.preventDefault():i.settings.splitOn&&setTimeout(function(){for(var t=C.trim(i.$control_input.val()||"").split(i.settings.splitOn),e=0,n=t.length;e<n;e++)i.createItem(t[e])},0)},onKeyPress:function(t){if(this.isLocked)return t&&t.preventDefault();var e=String.fromCharCode(t.keyCode||t.which);return this.settings.create&&"multi"===this.settings.mode&&e===this.settings.delimiter?(this.createItem(),t.preventDefault(),!1):void 0},onKeyDown:function(t){var e=(t.target,this.$control_input[0],this);if(!e.isLocked){switch(t.keyCode){case 65:if(e.isCmdDown)return void e.selectAll();break;case 27:return void(e.isOpen&&(t.preventDefault(),t.stopPropagation(),e.close()));case 78:if(!t.ctrlKey||t.altKey)break;case 40:if(!e.isOpen&&e.hasOptions)e.open();else if(e.$activeOption){e.ignoreHover=!0;var n=e.getAdjacentOption(e.$activeOption,1);n.length&&e.setActiveOption(n,!0,!0)}return void t.preventDefault();case 80:if(!t.ctrlKey||t.altKey)break;case 38:if(e.$activeOption){e.ignoreHover=!0;var i=e.getAdjacentOption(e.$activeOption,-1);i.length&&e.setActiveOption(i,!0,!0)}return void t.preventDefault();case 13:return void(e.isOpen&&e.$activeOption&&(e.onOptionSelect({currentTarget:e.$activeOption}),t.preventDefault()));case 37:return void e.advanceSelection(-1,t);case 39:return void e.advanceSelection(1,t);case 9:return e.settings.selectOnTab&&e.isOpen&&e.$activeOption&&(e.onOptionSelect({currentTarget:e.$activeOption}),e.isFull()||t.preventDefault()),void(e.settings.create&&e.createItem()&&t.preventDefault());case 8:case 46:return void e.deleteSelection(t)}return!e.isFull()&&!e.isInputHidden||(O?t.metaKey:t.ctrlKey)?void 0:void t.preventDefault()}9!==t.keyCode&&t.preventDefault()},onKeyUp:function(t){var e=this;if(e.isLocked)return t&&t.preventDefault();var n=e.$control_input.val()||"";e.lastValue!==n&&(e.lastValue=n,e.onSearchChange(n),e.refreshOptions(),e.trigger("type",n))},onSearchChange:function(e){var n=this,i=n.settings.load;i&&(n.loadedSearches.hasOwnProperty(e)||(n.loadedSearches[e]=!0,n.load(function(t){i.apply(n,[e,t])})))},onFocus:function(t){var e=this,n=e.isFocused;return e.isDisabled?(e.blur(),t&&t.preventDefault(),!1):void(e.ignoreFocus||(e.isFocused=!0,"focus"===e.settings.preload&&e.onSearchChange(""),n||e.trigger("focus"),e.$activeItems.length||(e.showInput(),e.setActiveItem(null),e.refreshOptions(!!e.settings.openOnFocus)),e.refreshState()))},onBlur:function(t,e){var n=this;if(n.isFocused&&(n.isFocused=!1,!n.ignoreFocus)){if(!n.ignoreBlur&&document.activeElement===n.$dropdown_content[0])return n.ignoreBlur=!0,void n.onFocus(t);var i=function(){n.close(),n.setTextboxValue(""),n.setActiveItem(null),n.setActiveOption(null),n.setCaret(n.items.length),n.refreshState(),(e||document.body).focus(),n.ignoreFocus=!1,n.trigger("blur")};n.ignoreFocus=!0,n.settings.create&&n.settings.createOnBlur?n.createItem(null,!1,i):i()}},onOptionHover:function(t){this.ignoreHover||this.setActiveOption(t.currentTarget,!1)},onOptionSelect:function(t){var e,n,i=this;t.preventDefault&&(t.preventDefault(),t.stopPropagation()),(n=C(t.currentTarget)).hasClass("create")?i.createItem(null,function(){i.settings.closeAfterSelect&&i.close()}):void 0!==(e=n.attr("data-value"))&&(i.lastQuery=null,i.setTextboxValue(""),i.addItem(e),i.settings.closeAfterSelect?i.close():!i.settings.hideSelected&&t.type&&/mouse/.test(t.type)&&i.setActiveOption(i.getOption(e)))},onItemSelect:function(t){this.isLocked||"multi"===this.settings.mode&&(t.preventDefault(),this.setActiveItem(t.currentTarget,t))},load:function(t){var e=this,n=e.$wrapper.addClass(e.settings.loadingClass);e.loading++,t.apply(e,[function(t){e.loading=Math.max(e.loading-1,0),t&&t.length&&(e.addOption(t),e.refreshOptions(e.isFocused&&!e.isInputHidden)),e.loading||n.removeClass(e.settings.loadingClass),e.trigger("load",t)}])},setTextboxValue:function(t){var e=this.$control_input;e.val()!==t&&(e.val(t).triggerHandler("update"),this.lastValue=t)},getValue:function(){return 1===this.tagType&&this.$input.attr("multiple")?this.items:this.items.join(this.settings.delimiter)},setValue:function(t,e){n(this,e?[]:["change"],function(){this.clear(e),this.addItems(t,e)})},setActiveItem:function(t,e){var n,i,o,r,s,a,l,p,u=this;if("single"!==u.settings.mode){if(!(t=C(t)).length)return C(u.$activeItems).removeClass("active"),u.$activeItems=[],void(u.isFocused&&u.showInput());if("mousedown"===(n=e&&e.type.toLowerCase())&&u.isShiftDown&&u.$activeItems.length){for(p=u.$control.children(".active:last"),r=Array.prototype.indexOf.apply(u.$control[0].childNodes,[p[0]]),(s=Array.prototype.indexOf.apply(u.$control[0].childNodes,[t[0]]))<r&&(l=r,r=s,s=l),i=r;i<=s;i++)a=u.$control[0].childNodes[i],-1===u.$activeItems.indexOf(a)&&(C(a).addClass("active"),u.$activeItems.push(a));e.preventDefault()}else"mousedown"===n&&u.isCtrlDown||"keydown"===n&&this.isShiftDown?t.hasClass("active")?(o=u.$activeItems.indexOf(t[0]),u.$activeItems.splice(o,1),t.removeClass("active")):u.$activeItems.push(t.addClass("active")[0]):(C(u.$activeItems).removeClass("active"),u.$activeItems=[t.addClass("active")[0]]);u.hideInput(),this.isFocused||u.focus()}},setActiveOption:function(t,e,n){var i,o,r,s,a,l=this;l.$activeOption&&l.$activeOption.removeClass("active"),l.$activeOption=null,(t=C(t)).length&&(l.$activeOption=t.addClass("active"),(e||!p(e))&&(i=l.$dropdown_content.height(),o=l.$activeOption.outerHeight(!0),e=l.$dropdown_content.scrollTop()||0,a=(s=r=l.$activeOption.offset().top-l.$dropdown_content.offset().top+e)-i+o,i+e<r+o?l.$dropdown_content.stop().animate({scrollTop:a},n?l.settings.scrollDuration:0):r<e&&l.$dropdown_content.stop().animate({scrollTop:s},n?l.settings.scrollDuration:0)))},selectAll:function(){var t=this;"single"!==t.settings.mode&&(t.$activeItems=Array.prototype.slice.apply(t.$control.children(":not(input)").addClass("active")),t.$activeItems.length&&(t.hideInput(),t.close()),t.focus())},hideInput:function(){this.setTextboxValue(""),this.$control_input.css({opacity:0,position:"absolute",left:this.rtl?1e4:-1e4}),this.isInputHidden=!0},showInput:function(){this.$control_input.css({opacity:1,position:"relative",left:0}),this.isInputHidden=!1},focus:function(){var t=this;t.isDisabled||(t.ignoreFocus=!0,t.$control_input[0].focus(),window.setTimeout(function(){t.ignoreFocus=!1,t.onFocus()},0))},blur:function(t){this.$control_input[0].blur(),this.onBlur(null,t)},getScoreFunction:function(t){return this.sifter.getScoreFunction(t,this.getSearchOptions())},getSearchOptions:function(){var t=this.settings,e=t.sortField;return"string"==typeof e&&(e=[{field:e}]),{fields:t.searchField,conjunction:t.searchConjunction,sort:e}},search:function(t){var e,n,i,o=this,r=o.settings,s=this.getSearchOptions();if(r.score&&"function"!=typeof(i=o.settings.score.apply(this,[t])))throw new Error('Selectize "score" setting must be a function that returns a function');if(t!==o.lastQuery?(o.lastQuery=t,n=o.sifter.search(t,C.extend(s,{score:i})),o.currentResults=n):n=C.extend(!0,{},o.currentResults),r.hideSelected)for(e=n.items.length-1;0<=e;e--)-1!==o.items.indexOf(I(n.items[e].id))&&n.items.splice(e,1);return n},refreshOptions:function(t){var e,n,i,o,r,s,a,l,p,u,c,d,h,g,f,v;void 0===t&&(t=!0);var m=this,y=C.trim(m.$control_input.val()),w=m.search(y),O=m.$dropdown_content,$=m.$activeOption&&I(m.$activeOption.attr("data-value"));for(o=w.items.length,"number"==typeof m.settings.maxOptions&&(o=Math.min(o,m.settings.maxOptions)),r={},s=[],e=0;e<o;e++)for(a=m.options[w.items[e].id],l=m.render("option",a),p=a[m.settings.optgroupField]||"",n=0,i=(u=C.isArray(p)?p:[p])&&u.length;n<i;n++)p=u[n],m.optgroups.hasOwnProperty(p)||(p=""),r.hasOwnProperty(p)||(r[p]=[],s.push(p)),r[p].push(l);for(this.settings.lockOptgroupOrder&&s.sort(function(t,e){return(m.optgroups[t].$order||0)-(m.optgroups[e].$order||0)}),c=[],e=0,o=s.length;e<o;e++)p=s[e],m.optgroups.hasOwnProperty(p)&&r[p].length?(d=m.render("optgroup_header",m.optgroups[p])||"",d+=r[p].join(""),c.push(m.render("optgroup",C.extend({},m.optgroups[p],{html:d})))):c.push(r[p].join(""));if(O.html(c.join("")),m.settings.highlight&&w.query.length&&w.tokens.length)for(e=0,o=w.tokens.length;e<o;e++)b(O,w.tokens[e].regex);if(!m.settings.hideSelected)for(e=0,o=m.items.length;e<o;e++)m.getOption(m.items[e]).addClass("selected");(h=m.canCreate(y))&&(O.prepend(m.render("option_create",{input:y})),v=C(O[0].childNodes[0])),m.hasOptions=0<w.items.length||h,m.hasOptions?(0<w.items.length?((f=$&&m.getOption($))&&f.length?g=f:"single"===m.settings.mode&&m.items.length&&(g=m.getOption(m.items[0])),g&&g.length||(g=v&&!m.settings.addPrecedence?m.getAdjacentOption(v,1):O.find("[data-selectable]:first"))):g=v,m.setActiveOption(g),t&&!m.isOpen&&m.open()):(m.setActiveOption(null),t&&m.isOpen&&m.close())},addOption:function(t){var e,n,i,o=this;if(C.isArray(t))for(e=0,n=t.length;e<n;e++)o.addOption(t[e]);else(i=o.registerOption(t))&&(o.userOptions[i]=!0,o.lastQuery=null,o.trigger("option_add",i,t))},registerOption:function(t){var e=I(t[this.settings.valueField]);return!(!e||this.options.hasOwnProperty(e))&&(t.$order=t.$order||++this.order,this.options[e]=t,e)},registerOptionGroup:function(t){var e=I(t[this.settings.optgroupValueField]);return!!e&&(t.$order=t.$order||++this.order,this.optgroups[e]=t,e)},addOptionGroup:function(t,e){e[this.settings.optgroupValueField]=t,(t=this.registerOptionGroup(e))&&this.trigger("optgroup_add",t,e)},removeOptionGroup:function(t){this.optgroups.hasOwnProperty(t)&&(delete this.optgroups[t],this.renderCache={},this.trigger("optgroup_remove",t))},clearOptionGroups:function(){this.optgroups={},this.renderCache={},this.trigger("optgroup_clear")},updateOption:function(t,e){var n,i,o,r,s,a,l,p=this;if(t=I(t),o=I(e[p.settings.valueField]),null!==t&&p.options.hasOwnProperty(t)){if("string"!=typeof o)throw new Error("Value must be set in option data");l=p.options[t].$order,o!==t&&(delete p.options[t],-1!==(r=p.items.indexOf(t))&&p.items.splice(r,1,o)),e.$order=e.$order||l,p.options[o]=e,s=p.renderCache.item,a=p.renderCache.option,s&&(delete s[t],delete s[o]),a&&(delete a[t],delete a[o]),-1!==p.items.indexOf(o)&&(n=p.getItem(t),i=C(p.render("item",e)),n.hasClass("active")&&i.addClass("active"),n.replaceWith(i)),p.lastQuery=null,p.isOpen&&p.refreshOptions(!1)}},removeOption:function(t,e){var n=this;t=I(t);var i=n.renderCache.item,o=n.renderCache.option;i&&delete i[t],o&&delete o[t],delete n.userOptions[t],delete n.options[t],n.lastQuery=null,n.trigger("option_remove",t),n.removeItem(t,e)},clearOptions:function(){var t=this;t.loadedSearches={},t.userOptions={},t.renderCache={},t.options=t.sifter.items={},t.lastQuery=null,t.trigger("option_clear"),t.clear()},getOption:function(t){return this.getElementWithValue(t,this.$dropdown_content.find("[data-selectable]"))},getAdjacentOption:function(t,e){var n=this.$dropdown.find("[data-selectable]"),i=n.index(t)+e;return 0<=i&&i<n.length?n.eq(i):C()},getElementWithValue:function(t,e){if(null!=(t=I(t)))for(var n=0,i=e.length;n<i;n++)if(e[n].getAttribute("data-value")===t)return C(e[n]);return C()},getItem:function(t){return this.getElementWithValue(t,this.$control.children())},addItems:function(t,e){for(var n=C.isArray(t)?t:[t],i=0,o=n.length;i<o;i++)this.isPending=i<o-1,this.addItem(n[i],e)},addItem:function(a,l){n(this,l?[]:["change"],function(){var t,e,n,i,o,r=this,s=r.settings.mode;return a=I(a),-1!==r.items.indexOf(a)?void("single"===s&&r.close()):void(r.options.hasOwnProperty(a)&&("single"===s&&r.clear(l),"multi"===s&&r.isFull()||(t=C(r.render("item",r.options[a])),o=r.isFull(),r.items.splice(r.caretPos,0,a),r.insertAtCaret(t),(!r.isPending||!o&&r.isFull())&&r.refreshState(),r.isSetup&&(n=r.$dropdown_content.find("[data-selectable]"),r.isPending||(e=r.getOption(a),i=r.getAdjacentOption(e,1).attr("data-value"),r.refreshOptions(r.isFocused&&"single"!==s),i&&r.setActiveOption(r.getOption(i))),!n.length||r.isFull()?r.close():r.positionDropdown(),r.updatePlaceholder(),r.trigger("item_add",a,t),r.updateOriginalInput({silent:l})))))})},removeItem:function(t,e){var n,i,o,r=this;n="object"==typeof t?t:r.getItem(t),t=I(n.attr("data-value")),-1!==(i=r.items.indexOf(t))&&(n.remove(),n.hasClass("active")&&(o=r.$activeItems.indexOf(n[0]),r.$activeItems.splice(o,1)),r.items.splice(i,1),r.lastQuery=null,!r.settings.persist&&r.userOptions.hasOwnProperty(t)&&r.removeOption(t,e),i<r.caretPos&&r.setCaret(r.caretPos-1),r.refreshState(),r.updatePlaceholder(),r.updateOriginalInput({silent:e}),r.positionDropdown(),r.trigger("item_remove",t,n))},createItem:function(t,n){var i=this,o=i.caretPos;t=t||C.trim(i.$control_input.val()||"");var r=arguments[arguments.length-1];if("function"!=typeof r&&(r=function(){}),"boolean"!=typeof n&&(n=!0),!i.canCreate(t))return r(),!1;i.lock();var e,s,a="function"==typeof i.settings.create?this.settings.create:function(t){var e={};return e[i.settings.labelField]=t,e[i.settings.valueField]=t,e},l=(s=!(e=function(t){if(i.unlock(),!t||"object"!=typeof t)return r();var e=I(t[i.settings.valueField]);return"string"!=typeof e?r():(i.setTextboxValue(""),i.addOption(t),i.setCaret(o),i.addItem(e),i.refreshOptions(n&&"single"!==i.settings.mode),void r(t))}),function(){s||(s=!0,e.apply(this,arguments))}),p=a.apply(this,[t,l]);return void 0!==p&&l(p),!0},refreshItems:function(){this.lastQuery=null,this.isSetup&&this.addItem(this.items),this.refreshState(),this.updateOriginalInput()},refreshState:function(){var t=this;t.isRequired&&(t.items.length&&(t.isInvalid=!1),t.$control_input.prop("required",void 0)),t.refreshClasses()},refreshClasses:function(){var t=this,e=t.isFull(),n=t.isLocked;t.$wrapper.toggleClass("rtl",t.rtl),t.$control.toggleClass("focus",t.isFocused).toggleClass("disabled",t.isDisabled).toggleClass("required",t.isRequired).toggleClass("invalid",t.isInvalid).toggleClass("locked",n).toggleClass("full",e).toggleClass("not-full",!e).toggleClass("input-active",t.isFocused&&!t.isInputHidden).toggleClass("dropdown-active",t.isOpen).toggleClass("has-options",!C.isEmptyObject(t.options)).toggleClass("has-items",0<t.items.length),t.$control_input.data("grow",!e&&!n)},isFull:function(){return null!==this.settings.maxItems&&this.items.length>=this.settings.maxItems},updateOriginalInput:function(t){var e,n,i,o,r=this;if(t=t||{},1===r.tagType){for(i=[],e=0,n=r.items.length;e<n;e++)o=r.options[r.items[e]][r.settings.labelField]||"",i.push('<option value="'+l(r.items[e])+'" selected="selected">'+l(o)+"</option>");i.length||this.$input.attr("multiple")||i.push('<option value="" selected="selected"></option>'),r.$input.html(i.join(""))}else r.$input.val(r.getValue()),r.$input.attr("value",r.$input.val());r.isSetup&&(t.silent||r.trigger("change",r.$input.val()))},updatePlaceholder:function(){if(this.settings.placeholder){var t=this.$control_input;this.items.length?t.removeAttr("placeholder"):t.attr("placeholder",this.settings.placeholder),t.triggerHandler("update",{force:!0})}},open:function(){var t=this;t.isLocked||t.isOpen||"multi"===t.settings.mode&&t.isFull()||(t.focus(),t.isOpen=!0,t.refreshState(),t.$dropdown.css({visibility:"hidden",display:"block"}),t.positionDropdown(),t.$dropdown.css({visibility:"visible"}),t.trigger("dropdown_open",t.$dropdown))},close:function(){var t=this,e=t.isOpen;"single"===t.settings.mode&&t.items.length&&t.hideInput(),t.isOpen=!1,t.$dropdown.hide(),t.setActiveOption(null),t.refreshState(),e&&t.trigger("dropdown_close",t.$dropdown)},positionDropdown:function(){var t=this.$control,e="body"===this.settings.dropdownParent?t.offset():t.position();e.top+=t.outerHeight(!0),this.$dropdown.css({width:t.outerWidth(),top:e.top,left:e.left})},clear:function(t){var e=this;e.items.length&&(e.$control.children(":not(input)").remove(),e.items=[],e.lastQuery=null,e.setCaret(0),e.setActiveItem(null),e.updatePlaceholder(),e.updateOriginalInput({silent:t}),e.refreshState(),e.showInput(),e.trigger("clear"))},insertAtCaret:function(t){var e=Math.min(this.caretPos,this.items.length);0===e?this.$control.prepend(t):C(this.$control[0].childNodes[e]).before(t),this.setCaret(e+1)},deleteSelection:function(t){var e,n,i,o,r,s,a,l,p,u=this;if(i=t&&8===t.keyCode?-1:1,o=d(u.$control_input[0]),u.$activeOption&&!u.settings.hideSelected&&(a=u.getAdjacentOption(u.$activeOption,-1).attr("data-value")),r=[],u.$activeItems.length){for(p=u.$control.children(".active:"+(0<i?"last":"first")),s=u.$control.children(":not(input)").index(p),0<i&&s++,e=0,n=u.$activeItems.length;e<n;e++)r.push(C(u.$activeItems[e]).attr("data-value"));t&&(t.preventDefault(),t.stopPropagation())}else(u.isFocused||"single"===u.settings.mode)&&u.items.length&&(i<0&&0===o.start&&0===o.length?r.push(u.items[u.caretPos-1]):0<i&&o.start===u.$control_input.val().length&&r.push(u.items[u.caretPos]));if(!r.length||"function"==typeof u.settings.onDelete&&!1===u.settings.onDelete.apply(u,[r]))return!1;for(void 0!==s&&u.setCaret(s);r.length;)u.removeItem(r.pop());return u.showInput(),u.positionDropdown(),u.refreshOptions(!0),a&&((l=u.getOption(a)).length&&u.setActiveOption(l)),!0},advanceSelection:function(t,e){var n,i,o,r,s,a=this;0!==t&&(a.rtl&&(t*=-1),n=0<t?"last":"first",i=d(a.$control_input[0]),a.isFocused&&!a.isInputHidden?(r=a.$control_input.val().length,(t<0?0===i.start&&0===i.length:i.start===r)&&!r&&a.advanceCaret(t,e)):(s=a.$control.children(".active:"+n)).length&&(o=a.$control.children(":not(input)").index(s),a.setActiveItem(null),a.setCaret(0<t?o+1:o)))},advanceCaret:function(t,e){var n,i,o=this;0!==t&&(n=0<t?"next":"prev",o.isShiftDown?(i=o.$control_input[n]()).length&&(o.hideInput(),o.setActiveItem(i),e&&e.preventDefault()):o.setCaret(o.caretPos+t))},setCaret:function(t){var e,n,i,o,r=this;if(t="single"===r.settings.mode?r.items.length:Math.max(0,Math.min(r.items.length,t)),!r.isPending)for(e=0,n=(i=r.$control.children(":not(input)")).length;e<n;e++)o=C(i[e]).detach(),e<t?r.$control_input.before(o):r.$control.append(o);r.caretPos=t},lock:function(){this.close(),this.isLocked=!0,this.refreshState()},unlock:function(){this.isLocked=!1,this.refreshState()},disable:function(){this.$input.prop("disabled",!0),this.$control_input.prop("disabled",!0).prop("tabindex",-1),this.isDisabled=!0,this.lock()},enable:function(){var t=this;t.$input.prop("disabled",!1),t.$control_input.prop("disabled",!1).prop("tabindex",t.tabIndex),t.isDisabled=!1,t.unlock()},destroy:function(){var t=this,e=t.eventNS,n=t.revertSettings;t.trigger("destroy"),t.off(),t.$wrapper.remove(),t.$dropdown.remove(),t.$input.html("").append(n.$children).removeAttr("tabindex").removeClass("selectized").attr({tabindex:n.tabindex}).show(),t.$control_input.removeData("grow"),t.$input.removeData("selectize"),C(window).off(e),C(document).off(e),C(document.body).off(e),delete t.$input[0].selectize},render:function(t,e){var n,i,o="",r=!1,s=this,a=/^[\t \r\n]*<([a-z][a-z0-9\-_]*(?:\:[a-z][a-z0-9\-_]*)?)/i;return("option"===t||"item"===t)&&(r=!!(n=I(e[s.settings.valueField]))),r&&(p(s.renderCache[t])||(s.renderCache[t]={}),s.renderCache[t].hasOwnProperty(n))?s.renderCache[t][n]:(o=s.settings.render[t].apply(this,[e,l]),("option"===t||"option_create"===t)&&(o=o.replace(a,"<$1 data-selectable")),"optgroup"===t&&(i=e[s.settings.optgroupValueField]||"",o=o.replace(a,'<$1 data-group="'+u(l(i))+'"')),("option"===t||"item"===t)&&(o=o.replace(a,'<$1 data-value="'+u(l(n||""))+'"')),r&&(s.renderCache[t][n]=o),o)},clearCache:function(t){void 0===t?this.renderCache={}:delete this.renderCache[t]},canCreate:function(t){if(!this.settings.create)return!1;var e=this.settings.createFilter;return!(!t.length||"function"==typeof e&&!e.apply(this,[t])||"string"==typeof e&&!new RegExp(e).test(t)||e instanceof RegExp&&!e.test(t))}}),y.count=0,y.defaults={options:[],optgroups:[],plugins:[],delimiter:",",splitOn:null,persist:!0,diacritics:!0,create:!1,createOnBlur:!1,createFilter:null,highlight:!0,openOnFocus:!0,maxOptions:1e3,maxItems:null,hideSelected:null,addPrecedence:!1,selectOnTab:!1,preload:!1,allowEmptyOption:!1,closeAfterSelect:!1,scrollDuration:60,loadThrottle:300,loadingClass:"loading",dataAttr:"data-data",optgroupField:"optgroup",valueField:"value",labelField:"text",optgroupLabelField:"label",optgroupValueField:"value",lockOptgroupOrder:!1,sortField:"$order",searchField:["text"],searchConjunction:"and",mode:null,wrapperClass:"selectize-control",inputClass:"selectize-input",dropdownClass:"selectize-dropdown",dropdownContentClass:"selectize-dropdown-content",dropdownParent:null,copyClassesToDropdown:!0,render:{}},C.fn.selectize=function(o){var r=C.fn.selectize.defaults,c=C.extend({},r,o),d=c.dataAttr,h=c.labelField,g=c.valueField,f=c.optgroupField,v=c.optgroupLabelField,m=c.optgroupValueField;return this.each(function(){if(!this.selectize){var t=C(this),e=this.tagName.toLowerCase(),n=t.attr("placeholder")||t.attr("data-placeholder");n||c.allowEmptyOption||(n=t.children('option[value=""]').text());var i={placeholder:n,options:[],optgroups:[],items:[]};"select"===e?function(t,s){var e,n,i,o,r=s.options,a={},l=function(t){var e=d&&t.attr(d);return"string"==typeof e&&e.length?JSON.parse(e):null},p=function(t,e){t=C(t);var n=I(t.attr("value"));if(n||c.allowEmptyOption)if(a.hasOwnProperty(n)){if(e){var i=a[n][f];i?C.isArray(i)?i.push(e):a[n][f]=[i,e]:a[n][f]=e}}else{var o=l(t)||{};o[h]=o[h]||t.text(),o[g]=o[g]||n,o[f]=o[f]||e,a[n]=o,r.push(o),t.is(":selected")&&s.items.push(n)}},u=function(t){var e,n,i,o,r;for((i=(t=C(t)).attr("label"))&&((o=l(t)||{})[v]=i,o[m]=i,s.optgroups.push(o)),e=0,n=(r=C("option",t)).length;e<n;e++)p(r[e],i)};for(s.maxItems=t.attr("multiple")?null:1,e=0,n=(o=t.children()).length;e<n;e++)"optgroup"===(i=o[e].tagName.toLowerCase())?u(o[e]):"option"===i&&p(o[e])}(t,i):function(t,e){var n,i,o,r,s=t.attr(d);if(s)for(e.options=JSON.parse(s),n=0,i=e.options.length;n<i;n++)e.items.push(e.options[n][g]);else{var a=C.trim(t.val()||"");if(!c.allowEmptyOption&&!a.length)return;for(n=0,i=(o=a.split(c.delimiter)).length;n<i;n++)(r={})[h]=o[n],r[g]=o[n],e.options.push(r);e.items=o}}(t,i),new y(t,C.extend(!0,{},r,i,o))}})},C.fn.selectize.defaults=y.defaults,C.fn.selectize.support={validity:S},y.define("drag_drop",function(){if(!C.fn.sortable)throw new Error('The "drag_drop" plugin requires jQuery UI "sortable".');if("multi"===this.settings.mode){var i=this;i.lock=(n=i.lock,function(){var t=i.$control.data("sortable");return t&&t.disable(),n.apply(i,arguments)}),i.unlock=(e=i.unlock,function(){var t=i.$control.data("sortable");return t&&t.enable(),e.apply(i,arguments)}),i.setup=(t=i.setup,function(){t.apply(this,arguments);var n=i.$control.sortable({items:"[data-value]",forcePlaceholderSize:!0,disabled:i.isLocked,start:function(t,e){e.placeholder.css("width",e.helper.css("width")),n.css({overflow:"visible"})},stop:function(){n.css({overflow:"hidden"});var t=i.$activeItems?i.$activeItems.slice():null,e=[];n.children("[data-value]").each(function(){e.push(C(this).attr("data-value"))}),i.setValue(e),i.setActiveItem(t)}})})}var t,e,n}),y.define("dropdown_header",function(t){var e,n=this;t=C.extend({title:"Untitled",headerClass:"selectize-dropdown-header",titleRowClass:"selectize-dropdown-header-title",labelClass:"selectize-dropdown-header-label",closeClass:"selectize-dropdown-header-close",html:function(t){return'<div class="'+t.headerClass+'"><div class="'+t.titleRowClass+'"><span class="'+t.labelClass+'">'+t.title+'</span><a href="javascript:void(0)" class="'+t.closeClass+'">&times;</a></div></div>'}},t),n.setup=(e=n.setup,function(){e.apply(n,arguments),n.$dropdown_header=C(t.html(t)),n.$dropdown.prepend(n.$dropdown_header)})}),y.define("optgroup_columns",function(a){var r,l=this;a=C.extend({equalizeWidth:!0,equalizeHeight:!0},a),this.getAdjacentOption=function(t,e){var n=t.closest("[data-group]").find("[data-selectable]"),i=n.index(t)+e;return 0<=i&&i<n.length?n.eq(i):C()},this.onKeyDown=(r=l.onKeyDown,function(t){var e,n,i,o;return!this.isOpen||37!==t.keyCode&&39!==t.keyCode?r.apply(this,arguments):(l.ignoreHover=!0,e=(o=this.$activeOption.closest("[data-group]")).find("[data-selectable]").index(this.$activeOption),void((n=(i=(o=37===t.keyCode?o.prev("[data-group]"):o.next("[data-group]")).find("[data-selectable]")).eq(Math.min(i.length-1,e))).length&&this.setActiveOption(n)))});var p=function(){var t,e=p.width,n=document;return void 0===e&&((t=n.createElement("div")).innerHTML='<div style="width:50px;height:50px;position:absolute;left:-50px;top:-50px;overflow:auto;"><div style="width:1px;height:100px;"></div></div>',t=t.firstChild,n.body.appendChild(t),e=p.width=t.offsetWidth-t.clientWidth,n.body.removeChild(t)),e},t=function(){var t,e,n,i,o,r,s;if((e=(s=C("[data-group]",l.$dropdown_content)).length)&&l.$dropdown_content.width()){if(a.equalizeHeight){for(t=n=0;t<e;t++)n=Math.max(n,s.eq(t).height());s.css({height:n})}a.equalizeWidth&&(r=l.$dropdown_content.innerWidth()-p(),i=Math.round(r/e),s.css({width:i}),1<e&&(o=r-i*(e-1),s.eq(e-1).css({width:o})))}};(a.equalizeHeight||a.equalizeWidth)&&(e.after(this,"positionDropdown",t),e.after(this,"refreshOptions",t))}),y.define("remove_button",function(t){if("single"!==this.settings.mode){t=C.extend({label:"&times;",title:"Remove",className:"remove",append:!0},t);var n=this,o='<a href="javascript:void(0)" class="'+t.className+'" tabindex="-1" title="'+l(t.title)+'">'+t.label+"</a>";this.setup=(e=n.setup,function(){if(t.append){var i=n.settings.render.item;n.settings.render.item=function(){return t=i.apply(this,arguments),e=o,n=t.search(/(<\/[^>]+>\s*)$/),t.substring(0,n)+e+t.substring(n);var t,e,n}}e.apply(this,arguments),this.$control.on("click","."+t.className,function(t){if(t.preventDefault(),!n.isLocked){var e=C(t.currentTarget).parent();n.setActiveItem(e),n.deleteSelection()&&n.setCaret(n.items.length)}})})}var e}),y.define("restore_on_backspace",function(i){var o,t=this;i.text=i.text||function(t){return t[this.settings.labelField]},this.onKeyDown=(o=t.onKeyDown,function(t){var e,n;return 8===t.keyCode&&""===this.$control_input.val()&&!this.$activeItems.length&&0<=(e=this.caretPos-1)&&e<this.items.length?(n=this.options[this.items[e]],this.deleteSelection(t)&&(this.setTextboxValue(i.text.apply(this,[n])),this.refreshOptions(!0)),void t.preventDefault()):o.apply(this,arguments)})}),y});
!function(t){"use strict";"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)}(function(n){"use strict";var a=[],e=[],i={precision:100,elapse:!1};e.push(/^[0-9]*$/.source),e.push(/([0-9]{1,2}\/){2}[0-9]{4}( [0-9]{1,2}(:[0-9]{2}){2})?/.source),e.push(/[0-9]{4}([\/\-][0-9]{1,2}){2}( [0-9]{1,2}(:[0-9]{2}){2})?/.source),e=new RegExp(e.join("|"));var g={Y:"years",m:"months",n:"daysToMonth",w:"weeks",d:"daysToWeek",D:"totalDays",H:"hours",M:"minutes",S:"seconds"},o=function(t,e,s){this.el=t,this.$el=n(t),this.interval=null,this.offset={},this.options=n.extend({},i),this.instanceNumber=a.length,a.push(this),this.$el.data("countdown-instance",this.instanceNumber),s&&("function"==typeof s?(this.$el.on("update.countdown",s),this.$el.on("stoped.countdown",s),this.$el.on("finish.countdown",s)):this.options=n.extend({},i,s)),this.setFinalDate(e),this.start()};n.extend(o.prototype,{start:function(){null!==this.interval&&clearInterval(this.interval);var t=this;this.update(),this.interval=setInterval(function(){t.update.call(t)},this.options.precision)},stop:function(){clearInterval(this.interval),this.interval=null,this.dispatchEvent("stoped")},toggle:function(){this.interval?this.stop():this.start()},pause:function(){this.stop()},resume:function(){this.start()},remove:function(){this.stop.call(this),a[this.instanceNumber]=null,delete this.$el.data().countdownInstance},setFinalDate:function(t){this.finalDate=function(t){if(t instanceof Date)return t;if(String(t).match(e))return String(t).match(/^[0-9]*$/)&&(t=Number(t)),String(t).match(/\-/)&&(t=String(t).replace(/\-/g,"/")),new Date(t);throw new Error("Couldn't cast `"+t+"` to a date object.")}(t)},update:function(){if(0!==this.$el.closest("html").length){var t,e=void 0!==n._data(this.el,"events"),s=new Date;t=this.finalDate.getTime()-s.getTime(),t=Math.ceil(t/1e3),t=!this.options.elapse&&t<0?0:Math.abs(t),this.totalSecsLeft!==t&&e&&(this.totalSecsLeft=t,this.elapsed=s>=this.finalDate,this.offset={seconds:this.totalSecsLeft%60,minutes:Math.floor(this.totalSecsLeft/60)%60,hours:Math.floor(this.totalSecsLeft/60/60)%24,days:Math.floor(this.totalSecsLeft/60/60/24)%7,daysToWeek:Math.floor(this.totalSecsLeft/60/60/24)%7,daysToMonth:Math.floor(this.totalSecsLeft/60/60/24%30.4368),totalDays:Math.floor(this.totalSecsLeft/60/60/24),weeks:Math.floor(this.totalSecsLeft/60/60/24/7),months:Math.floor(this.totalSecsLeft/60/60/24/30.4368),years:Math.abs(this.finalDate.getFullYear()-s.getFullYear())},this.options.elapse||0!==this.totalSecsLeft?this.dispatchEvent("update"):(this.stop(),this.dispatchEvent("finish")))}else this.remove()},dispatchEvent:function(t){var v,e=n.Event(t+".countdown");e.finalDate=this.finalDate,e.elapsed=this.elapsed,e.offset=n.extend({},this.offset),e.strftime=(v=this.offset,function(t){var e,s,i,n,a,o,h=t.match(/%(-|!)?[A-Z]{1}(:[^;]+;)?/gi);if(h)for(var l=0,r=h.length;l<r;++l){var c=h[l].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),f=(a=c[0],o=a.toString().replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1"),new RegExp(o)),u=c[1]||"",p=c[3]||"",d=null;c=c[2],g.hasOwnProperty(c)&&(d=g[c],d=Number(v[d])),null!==d&&("!"===u&&(s=d,n=i=void 0,i="s",n="",(e=p)&&(1===(e=e.replace(/(:|;|\s)/gi,"").split(/\,/)).length?i=e[0]:(n=e[0],i=e[1])),d=1===Math.abs(s)?n:i),""===u&&d<10&&(d="0"+d.toString()),t=t.replace(f,d.toString()))}return t.replace(/%%/,"%")}),this.$el.trigger(e)}}),n.fn.countdown=function(){var i=Array.prototype.slice.call(arguments,0);return this.each(function(){var t=n(this).data("countdown-instance");if(void 0!==t){var e=a[t],s=i[0];o.prototype.hasOwnProperty(s)?e[s].apply(e,i.slice(1)):null===String(s).match(/^[$A-Z_][0-9A-Z_$]*$/i)?(e.setFinalDate.call(e,s),e.start()):n.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi,s))}else new o(this,i[0],i[1])})}});
...
window.Modernizr=function(r,d,i){function n(e){h.cssText=e}function a(e,t){return typeof e===t}function o(e,t){return!!~(""+e).indexOf(t)}function c(e,t){for(var n in e){var r=e[n];if(!o(r,"-")&&h[r]!==i)return"pfx"!=t||r}return!1}function s(e,t,n){var r=e.charAt(0).toUpperCase()+e.slice(1),o=(e+" "+x.join(r+" ")+r).split(" ");return a(t,"string")||a(t,"undefined")?c(o,t):function(e,t,n){for(var r in e){var o=t[e[r]];if(o!==i)return!1===n?e[r]:a(o,"function")?o.bind(n||t):o}return!1}(o=(e+" "+w.join(r+" ")+r).split(" "),t,n)}var e,u,l,f={},m=d.documentElement,p="modernizr",t=d.createElement(p),h=t.style,g=d.createElement("input"),v=":)",y={}.toString,b=" -webkit- -moz- -o- -ms- ".split(" "),E="Webkit Moz O ms",x=E.split(" "),w=E.toLowerCase().split(" "),S="http://www.w3.org/2000/svg",C={},k={},T={},N=[],M=N.slice,P=function(e,t,n,r){var o,a,i,c,s=d.createElement("div"),u=d.body,l=u||d.createElement("body");if(parseInt(n,10))for(;n--;)(i=d.createElement("div")).id=r?r[n]:p+(n+1),s.appendChild(i);return o=["&#173;",'<style id="s',p,'">',e,"</style>"].join(""),s.id=p,(u?s:l).innerHTML+=o,l.appendChild(s),u||(l.style.background="",l.style.overflow="hidden",c=m.style.overflow,m.style.overflow="hidden",m.appendChild(l)),a=t(s,e),u?s.parentNode.removeChild(s):(l.parentNode.removeChild(l),m.style.overflow=c),!!a},j=(l={select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"},function(e,t){t=t||d.createElement(l[e]||"div");var n=(e="on"+e)in t;return n||(t.setAttribute||(t=d.createElement("div")),t.setAttribute&&t.removeAttribute&&(t.setAttribute(e,""),n=a(t[e],"function"),a(t[e],"undefined")||(t[e]=i),t.removeAttribute(e))),t=null,n}),$={}.hasOwnProperty;for(var D in u=a($,"undefined")||a($.call,"undefined")?function(e,t){return t in e&&a(e.constructor.prototype[t],"undefined")}:function(e,t){return $.call(e,t)},Function.prototype.bind||(Function.prototype.bind=function(r){var o=this;if("function"!=typeof o)throw new TypeError;var a=M.call(arguments,1),i=function(){if(this instanceof i){var e=function(){};e.prototype=o.prototype;var t=new e,n=o.apply(t,a.concat(M.call(arguments)));return Object(n)===n?n:t}return o.apply(r,a.concat(M.call(arguments)))};return i}),C.flexbox=function(){return s("flexWrap")},C.flexboxlegacy=function(){return s("boxDirection")},C.canvas=function(){var e=d.createElement("canvas");return!(!e.getContext||!e.getContext("2d"))},C.canvastext=function(){return!(!f.canvas||!a(d.createElement("canvas").getContext("2d").fillText,"function"))},C.webgl=function(){return!!r.WebGLRenderingContext},C.touch=function(){var t;return"ontouchstart"in r||r.DocumentTouch&&d instanceof DocumentTouch?t=!0:P(["@media (",b.join("touch-enabled),("),p,")","{#modernizr{top:9px;position:absolute}}"].join(""),function(e){t=9===e.offsetTop}),t},C.geolocation=function(){return"geolocation"in navigator},C.postmessage=function(){return!!r.postMessage},C.websqldatabase=function(){return!!r.openDatabase},C.indexedDB=function(){return!!s("indexedDB",r)},C.hashchange=function(){return j("hashchange",r)&&(d.documentMode===i||7<d.documentMode)},C.history=function(){return!(!r.history||!history.pushState)},C.draganddrop=function(){var e=d.createElement("div");return"draggable"in e||"ondragstart"in e&&"ondrop"in e},C.websockets=function(){return"WebSocket"in r||"MozWebSocket"in r},C.rgba=function(){return n("background-color:rgba(150,255,150,.5)"),o(h.backgroundColor,"rgba")},C.hsla=function(){return n("background-color:hsla(120,40%,100%,.5)"),o(h.backgroundColor,"rgba")||o(h.backgroundColor,"hsla")},C.multiplebgs=function(){return n("background:url(https://),url(https://),red url(https://)"),/(url\s*\(.*?){3}/.test(h.background)},C.backgroundsize=function(){return s("backgroundSize")},C.borderimage=function(){return s("borderImage")},C.borderradius=function(){return s("borderRadius")},C.boxshadow=function(){return s("boxShadow")},C.textshadow=function(){return""===d.createElement("div").style.textShadow},C.opacity=function(){return e="opacity:.55",n(b.join(e+";")+(t||"")),/^0.55$/.test(h.opacity);var e,t},C.cssanimations=function(){return s("animationName")},C.csscolumns=function(){return s("columnCount")},C.cssgradients=function(){var e="background-image:";return n((e+"-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));"+e)+b.join("linear-gradient(left top,#9f9, white);"+e)).slice(0,-e.length)),o(h.backgroundImage,"gradient")},C.cssreflections=function(){return s("boxReflect")},C.csstransforms=function(){return!!s("transform")},C.csstransforms3d=function(){var t=!!s("perspective");return t&&"webkitPerspective"in m.style&&P("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}",function(e){t=9===e.offsetLeft&&3===e.offsetHeight}),t},C.csstransitions=function(){return s("transition")},C.fontface=function(){var a;return P('@font-face {font-family:"font";src:url("https://")}',function(e,t){var n=d.getElementById("smodernizr"),r=n.sheet||n.styleSheet,o=r?r.cssRules&&r.cssRules[0]?r.cssRules[0].cssText:r.cssText||"":"";a=/src/i.test(o)&&0===o.indexOf(t.split(" ")[0])}),a},C.generatedcontent=function(){var t;return P(["#",p,"{font:0/0 a}#",p,':after{content:"',v,'";visibility:hidden;font:3px/1 a}'].join(""),function(e){t=3<=e.offsetHeight}),t},C.video=function(){var e=d.createElement("video"),t=!1;try{(t=!!e.canPlayType)&&((t=new Boolean(t)).ogg=e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,""),t.h264=e.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,""),t.webm=e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,""))}catch(e){}return t},C.audio=function(){var e=d.createElement("audio"),t=!1;try{(t=!!e.canPlayType)&&((t=new Boolean(t)).ogg=e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,""),t.mp3=e.canPlayType("audio/mpeg;").replace(/^no$/,""),t.wav=e.canPlayType('audio/wav; codecs="1"').replace(/^no$/,""),t.m4a=(e.canPlayType("audio/x-m4a;")||e.canPlayType("audio/aac;")).replace(/^no$/,""))}catch(e){}return t},C.localstorage=function(){try{return localStorage.setItem(p,p),localStorage.removeItem(p),!0}catch(e){return!1}},C.sessionstorage=function(){try{return sessionStorage.setItem(p,p),sessionStorage.removeItem(p),!0}catch(e){return!1}},C.webworkers=function(){return!!r.Worker},C.applicationcache=function(){return!!r.applicationCache},C.svg=function(){return!!d.createElementNS&&!!d.createElementNS(S,"svg").createSVGRect},C.inlinesvg=function(){var e=d.createElement("div");return e.innerHTML="<svg/>",(e.firstChild&&e.firstChild.namespaceURI)==S},C.smil=function(){return!!d.createElementNS&&/SVGAnimate/.test(y.call(d.createElementNS(S,"animate")))},C.svgclippaths=function(){return!!d.createElementNS&&/SVGClipPath/.test(y.call(d.createElementNS(S,"clipPath")))},C)u(C,D)&&(e=D.toLowerCase(),f[e]=C[D](),N.push((f[e]?"":"no-")+e));return f.input||(f.input=function(e){for(var t=0,n=e.length;t<n;t++)T[e[t]]=!!(e[t]in g);return T.list&&(T.list=!(!d.createElement("datalist")||!r.HTMLDataListElement)),T}("autocomplete autofocus list placeholder max min multiple pattern required step".split(" ")),f.inputtypes=function(e){for(var t,n,r,o=0,a=e.length;o<a;o++)g.setAttribute("type",n=e[o]),(t="text"!==g.type)&&(g.value=v,g.style.cssText="position:absolute;visibility:hidden;",/^range$/.test(n)&&g.style.WebkitAppearance!==i?(m.appendChild(g),t=(r=d.defaultView).getComputedStyle&&"textfield"!==r.getComputedStyle(g,null).WebkitAppearance&&0!==g.offsetHeight,m.removeChild(g)):/^(search|tel)$/.test(n)||(t=/^(url|email)$/.test(n)?g.checkValidity&&!1===g.checkValidity():g.value!=v)),k[e[o]]=!!t;return k}("search tel url email datetime date month week time datetime-local number range color".split(" "))),f.addTest=function(e,t){if("object"==typeof e)for(var n in e)u(e,n)&&f.addTest(n,e[n]);else{if(e=e.toLowerCase(),f[e]!==i)return f;t="function"==typeof t?t():t,m.className+=" "+(t?"":"no-")+e,f[e]=t}return f},n(""),t=g=null,function(e,s){function u(){var e=p.elements;return"string"==typeof e?e.split(" "):e}function l(e){var t=c[e[r]];return t||(t={},i++,e[r]=i,c[i]=t),t}function d(e,t,n){return t||(t=s),m?t.createElement(e):(n||(n=l(t)),!(r=n.cache[e]?n.cache[e].cloneNode():a.test(e)?(n.cache[e]=n.createElem(e)).cloneNode():n.createElem(e)).canHaveChildren||o.test(e)||r.tagUrn?r:n.frag.appendChild(r));var r}function t(e){e||(e=s);var t,n,r,o,a,i,c=l(e);return!p.shivCSS||f||c.hasCSS||(c.hasCSS=(o="article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}",a=(r=e).createElement("p"),i=r.getElementsByTagName("head")[0]||r.documentElement,a.innerHTML="x<style>"+o+"</style>",!!i.insertBefore(a.lastChild,i.firstChild))),m||(t=e,(n=c).cache||(n.cache={},n.createElem=t.createElement,n.createFrag=t.createDocumentFragment,n.frag=n.createFrag()),t.createElement=function(e){return p.shivMethods?d(e,t,n):n.createElem(e)},t.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+u().join().replace(/[\w\-]+/g,function(e){return n.createElem(e),n.frag.createElement(e),'c("'+e+'")'})+");return n}")(p,n.frag)),e}var f,m,n=e.html5||{},o=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,a=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,r="_html5shiv",i=0,c={};!function(){try{var e=s.createElement("a");e.innerHTML="<xyz></xyz>",f="hidden"in e,m=1==e.childNodes.length||function(){s.createElement("a");var e=s.createDocumentFragment();return void 0===e.cloneNode||void 0===e.createDocumentFragment||void 0===e.createElement}()}catch(e){m=f=!0}}();var p={elements:n.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:"3.7.0",shivCSS:!1!==n.shivCSS,supportsUnknownElements:m,shivMethods:!1!==n.shivMethods,type:"default",shivDocument:t,createElement:d,createDocumentFragment:function(e,t){if(e||(e=s),m)return e.createDocumentFragment();for(var n=(t=t||l(e)).frag.cloneNode(),r=0,o=u(),a=o.length;r<a;r++)n.createElement(o[r]);return n}};e.html5=p,t(s)}(this,d),f._version="2.8.3",f._prefixes=b,f._domPrefixes=w,f._cssomPrefixes=x,f.mq=function(e){var t,n=r.matchMedia||r.msMatchMedia;return n?n(e)&&n(e).matches||!1:(P("@media "+e+" { #"+p+" { position: absolute; } }",function(e){t="absolute"==(r.getComputedStyle?getComputedStyle(e,null):e.currentStyle).position}),t)},f.hasEvent=j,f.testProp=function(e){return c([e])},f.testAllProps=s,f.testStyles=P,f.prefixed=function(e,t,n){return t?s(e,t,n):s(e,"pfx")},m.className=m.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+" js "+N.join(" "),f}(this,this.document);
jQuery(document).ready(function(){"use strict";var t,e,a,i,o;void 0===a&&(a=(e=(t=$('<div style="width: 50px; height: 50px; overflow: auto"><div/></div>').appendTo("body")).children()).innerWidth()-e.height(99).innerWidth(),t.remove()),$(function(){$('[data-toggle="tooltip"]').tooltip()}),$("a[rel=popover]").popover().click(function(t){t.preventDefault();$(this).attr("data-easein")}),$(".search-box").length&&($("#search").on("click",function(){$(".search-box").addClass("open")}),$(".search-box span").on("click",function(){$(".search-box").removeClass("open")})),$("#myModal").on("shown.bs.modal",function(){$("#myInput").trigger("focus")}),$(".open-popup").magnificPopup({type:"inline",midClick:!0,removalDelay:500,callbacks:{beforeOpen:function(){this.st.mainClass=this.st.el.attr("data-effect")}}}),$(".chislo-item").waypoint(function(){$({blurRadius:5}).animate({blurRadius:0},{duration:1200,easing:"swing",step:function(){$(".chislo-item span").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var e=$.animateNumber.numberStepFactories.separator(" ");$(".chislo-item  span").each(function(){var t=$(this).data("count");$(this).animateNumber({number:t,easing:"easeInQuad","font-size":"1.8125em",numberStep:e},1200)}),this.destroy()},{offset:"70%"}),$("#works-carousel").owlCarousel({loop:!0,nav:!0,dots:!1,smartSpeed:700,navText:['<i class="fas fa-angle-left"></i>','<i class="fas fa-angle-right"></i>'],lazyLoad:!0,autoplay:!0,margin:20,pagination:!1,responsive:{0:{items:1},600:{items:3},1e3:{items:5}}}),$(".next").click(function(){owl.trigger("next.owl.carousel")}),$(".prev").click(function(){owl.trigger("prev.owl.carousel")}),$("[data-countdown]").each(function(){var e=$(this),t=$(this).data("countdown");e.countdown(t,function(t){e.html(t.strftime("%D"))})}),$(".pgwSlideshow").pgwSlideshow(),$(".image-link").magnificPopup({type:"image"}),$(".mfp-gallery").each(function(){$(this).magnificPopup({delegate:"a",mainClass:"mfp-zoom-in",type:"image",tLoading:"",image:{verticalFit:!0,titleSrc:function(t){return t.el.attr("title")}},gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1],arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',tPrev:"Previous (Left arrow key)",tNext:"Next (Right arrow key)",tCounter:'<span class="mfp-counter">%curr% of %total%</span>'},removalDelay:300,callbacks:{beforeChange:function(){this.items[0].src=this.items[0].src+"?="+Math.random()},open:function(){$.magnificPopup.instance.next=function(){var t=this;t.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.next.call(t)},120)},$.magnificPopup.instance.prev=function(){var t=this;t.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.prev.call(t)},120)}},imageLoadComplete:function(){var t=this;setTimeout(function(){t.wrap.addClass("mfp-image-loaded")},16)}}})}),$(".next-step").click(function(t){var e=$(".nav-tabs li.active");nextTab(e)}),$(i).next().find('a[data-toggle="tab"]').click(),$(o).prev().find('a[data-toggle="tab"]').click()}()),jQuery("#backtotop").click(function(){jQuery("body,html").animate({scrollTop:0},600)}),jQuery(window).scroll(function(){150<jQuery(window).scrollTop()?jQuery("#backtotop").addClass("visible"):jQuery("#backtotop").removeClass("visible")}),new WOW({mobile:!1}).init();