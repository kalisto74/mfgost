  ...
  <div class="row mt-5 align-items-top justify-content-center">
    <div class="col-xs-12 col-sm-6">
      <div class="d-inline-block pr-5">
        ...
        <p class="card-text">Покрытие: <span class="text-muted">[[*pokritieKuxni]]</span></p>
      </div>
      <div  class="ral d-inline-block align-top pl-1">
        [[#[[*color]].ral:ne=``:then=`<a href="#" ><div class="ral-color" style="background-color: [[#[[*color]].ral]];"></div></a>`:else=`<a href="#" ><div class="ral-color">
        [[getImageList?
          &docid=`[[*color]]`
          &tvname=`foto`
...
<div class="container-fluid">
  <div class="row mt-5 mb-5">
    <div class="col-sm-12">
      ...
      <p class="small muted text-right">Стоимость без учета бытовой техники: 100 000 руб.</p>
    </div>
  </div>
</div>
<!--Фото-->
...
<div class="container">
  ...
  <div class="row mt-3">
    <div class="col">
      ...
      <p class="text-muted mt-2 mb-2"><a href="[[~[[*parent]]]]" title="Блог" alt=""><span class="pr-2"><i class="fas fa-arrow-circle-left"></i></span><u>К кухням</u></a></p>
    </div>
  </div>
  <!--Соцсети-->
  [[$socSeti]]
